...
# Game QA – Jira Bug Report (Playtest)

## Overview
This repository contains a Jira-style gameplay bug report created as part of my QA portfolio.
The bug was identified during a playtest session and documents a combat issue where an enemy
does not take damage when hit by the player.

## Contents
- Jira-style bug report (PDF)
